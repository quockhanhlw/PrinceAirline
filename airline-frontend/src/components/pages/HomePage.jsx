...
const HomePage = () => {
    ...
    const handleSearch = (e) => {
        ...
        const params = new URLSearchParams({
            departureIataCode: searchData.departureIataCode,
            arrivalIataCode: searchData.arrivalIataCode,
        ...
        <div className="home-page">
            <div className="hero-section">
                <div className="hero-content">
                    <h1>Book Your Flight with Prince Airlines</h1>
                        ...
                        <div className="search-fields">
                            ...
                            <div className="swap-cities">
                                <button
                                    ...
                                    className="btn-swap" // Thêm class nếu cần style
                                >
                                    ↔
                                </button>
                            </div>
            ...
            <section className="features-section">
                <h2>Why Choose Prince Airlines?</h2>
                ...
                <div className="testimonials-grid">
                    <div className="testimonial-card">
                        <div className="testimonial-text">
                            "The service was exceptional from booking to landing. Will definitely fly with Prince again!"
                        </div>
